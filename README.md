...
![Version](https://img.shields.io/badge/version-1.0.5-blue) ![GitHub language count](https://img.shields.io/github/languages/count/falken20/parrao_weather_web) ![GitHub Top languaje](https://img.shields.io/github/languages/top/falken20/parrao_weather_web) ![Test coverage](https://img.shields.io/badge/test%20coverage-99
%25-green) ![GitHub License](https://img.shields.io/github/license/falken20/search_extensions)
...
##### Deploy with local credentials file (credentials.yaml)
`app.yaml` in App Engine does not support `includes:` natively.
Use this helper flow instead:

```bash
cp credentials.yaml.example credentials.yaml
# Edit credentials.yaml with your real values
./run_app.sh --deploy
```

Or explicit files/flags:
...
Profile: https://www.wunderground.com/
